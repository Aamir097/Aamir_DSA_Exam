...
public:
    ...
    void insert_AtBeginning(int data)
    {
    ...
    void insert_AtIndex(int index, int data)
    {
...
int main()
{
    ...
    do
    {
        ...
        case 1:
            cout << "Enter element: ";
            cin >> element;
            list.insert_AtBeginning(element);
            break;
        case 2:
            cout << "Enter element: ";
            cin >> element;
            list.insert_AtEnd(element);
            break;
        case 3:
            ...
            cout << "Enter element: ";
            cin >> element;
            list.insert_AtIndex(index, element);
            break;
        case 4:
